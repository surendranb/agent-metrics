...
class AM_Bot_Catalog {
	...
	private static $bots = array(
		...
		'chatgpt-user'     => array(
			'name'     => 'ChatGPT User',
			'category' => 'on-demand',
			'patterns' => array( 'chatgpt-user', 'chatgpt' ),
		),
		'claudebot'        => array(
			'name'     => 'ClaudeBot',
			'category' => 'training',
			'patterns' => array( 'claudebot' ),
		),
		'claude-searchbot' => array(
			'name'     => 'Claude SearchBot',
			'category' => 'search',
			'patterns' => array( 'claude-searchbot' ),
		),
		'claude-user'      => array(
			'name'     => 'Claude User',
			'category' => 'on-demand',
		...
		'claude-web'       => array(
			'name'     => 'Claude Web',
			'category' => 'on-demand',
			'patterns' => array( 'claude-web' ),
		),
		'anthropic-ai'     => array(
			'name'     => 'Anthropic AI',
			'category' => 'training',
			'patterns' => array( 'anthropic-ai', 'anthropicai' ),
		),
		'ccbot'            => array(
			'name'     => 'Common Crawl',
			'category' => 'training',
		...
		'googleother'      => array(
			'name'     => 'GoogleOther',
			'category' => 'training',
			'patterns' => array( 'googleother', 'google-other' ),
		),
		'perplexitybot'    => array(
			'name'     => 'PerplexityBot',
			'category' => 'search',
		...
		'researchbot'      => array(
			'name'     => 'researchbot (You.com)',
			'category' => 'search',
			'patterns' => array( 'researchbot' ),
		),
		'dataforseobot'    => array(
			'name'     => 'DataForSeoBot',
			'category' => 'search',
		...
		'duckassistbot'    => array(
			'name'     => 'DuckAssistBot',
			'category' => 'search',
			'patterns' => array( 'duckassistbot' ),
		),
		'falkor'           => array(
			'name'     => 'Falkor (Wave)',
			'category' => 'search',
			'patterns' => array( 'falkor' ),
		),
		'brave'            => array(
			'name'     => 'Brave Search',
			'category' => 'search',
			'patterns' => array( 'brave-search' ),
		),
		'seekrbot'         => array(
			'name'     => 'SeekrBot',
			'category' => 'search',
			'patterns' => array( 'seekrbot' ),
		),
		'timpibot'         => array(
			'name'     => 'TimpiBot',
			'category' => 'search',
		...
		'mistralai-index'  => array(
			'name'     => 'Mistral AI Index',
			'category' => 'search',
			'patterns' => array( 'mistralai-index' ),
		),
		'bingbot'          => array(
			'name'     => 'Bingbot',
			'category' => 'search',
		...
		'cohere'           => array(
			'name'     => 'Cohere AI',
			'category' => 'training',
			'patterns' => array( 'cohere-ai', 'cohereai' ),
		),
		'diffbot'          => array(
			'name'     => 'Diffbot',
			'category' => 'training',
		...
		'brightbot'        => array(
			'name'     => 'Brightbot',
			'category' => 'training',
			'patterns' => array( 'brightbot-1', 'brightbot' ),
		),
		'omgili'           => array(
			'name'     => 'Omgili',
			'category' => 'training',
			'patterns' => array( 'omgili', 'omgilibot' ),
		),
		'firecrawl'        => array(
			'name'     => 'Firecrawl',
			'category' => 'training',
			'patterns' => array( 'firecrawl' ),
		),
		'glasp'            => array(
			'name'     => 'Glasp',
			'category' => 'training',
			'patterns' => array( 'glasp' ),
		),
		'synapseai'        => array(
			'name'     => 'SynapseAI',
			'category' => 'training',
			'patterns' => array( 'synapseai' ),
		),
		'kangaroobot'      => array(
			'name'     => 'KangarooBot',
			'category' => 'search',
			'patterns' => array( 'kangaroobot' ),
		),
		'ai2bot'           => array(
			'name'     => 'AI2Bot (Allen AI)',
			'category' => 'training',
			'patterns' => array( 'ai2bot', 's2bot' ),
		),
	);
